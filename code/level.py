...
class Level:
    ...
    def generate_sprites(self):
        ...
        self.ground = Ground()
        self.fountain = Object([self.visible_group, self.obsticale_group], (410, 900), 'fountain')
        self.fountain = Object([self.visible_group, self.obsticale_group], (620, 300), 'big_tourch')
        self.fountain = Object([self.visible_group, self.obsticale_group], (440, 300), 'big_tourch')
